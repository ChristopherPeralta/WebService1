 ...
 * 
 */
@WebServiceClient(name = "WS02", targetNamespace = "http://ws.company.pe/", wsdlLocation = "http://localhost:8080/WService/WS02?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WService/WS02?WSDL");
